          ...
          <div className='flex flex-wrap lg:flex-nowrap items-center pt-10 w-100 justify-between'>
            <div className='w-full lg:w-1/2'>
              ...
              <p className='mb-5 text-[18px]'>
                Show off your Products, Share your story. Expand sales with one
                clean link-in bio.
              </p>
        ...
        <section className='container'>
          <div className='flex flex-wrap gap-8 lg:flex-nowrap items-center pt-10 w-100 justify-between'>
            ...
            <div className='w-full order-1 lg:order-2 lg:w-1/2'>
              ...
              <p className='mb-5'>
                Use your unique Trimmo.bio URL to create a storefront that works
                for you. Display your best Products, highlight new trends, and
                distribute updates with ease.
              </p>
          ...
          <div className='grid work grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-5'>
            ...
            >
              ...
              <p className='info-text'>
                Include links to your items and podcasts. Keep everything your
                audience needs in one location.
              </p>
              <div>
            ...
            >
              ...
              <p className='info-text'>
                Make an effort to sell real or digital goods, such as handmade
                jewelry, art prints, apparel, or unique e-books.
              </p>
              <div>
                <a
            ...
            >
              ...
              <p className='info-text'>
                Create email signups or forms to generate leads and establish a
                loyal consumer base.
              </p>
              <div>
                ...
                <div className='accordion'>
                  {faqData.map((item, index) => (
                    <div className='accordion-item' key={index}>
                      ...
                      >
                        <p
                          className={`accordion-title text-base font-semibold`}
                        >
                          {item.question}
                        </p>
                        <span
        ...
        <section className='container'>
          <div className='flex flex-wrap gap-8 lg:flex-nowrap items-center pt-10 w-100 justify-between'>
            ...
            <div className='w-full order-1 lg:order-2 lg:w-1/2'>
              ...
              <p className='mb-5'>
                Trimmo.bio is trusted by manufacturers, entrepreneurs, and
                businesses to help them navigate the e-commerce landscape.
              </p>
              <span className='font-medium mb-4 block'>
                Some of our creators include:
              </span>
              <ul className='list-disc m-0 pl-10 flex flex-col gap-2'>
            ...
            <div className='flex items-center gap-5 flex-grow flex-wrap sm:flex-nowrap'>
              ...
              <div>
                ...
                <p className='info-text text-[#6a6a74]'>
                  A link that connects all of your activities. Get your own
                  Trimmo.bio for free and take your eCommerce to the next level.
                </p>
              </div>
            </div>
