        ...
        <div className='flex flex-wrap lg:flex-nowrap items-center pt-10 w-100 justify-between'>
          <div className='w-full lg:w-1/2'>
            ...
            <p className='mb-5 text-[18px]'>
              Trimmo.bio's powerful inventory system allows you to effortlessly
              manage your products. Whether you sell physical or digital
              products, we make it simple to keep track of your stock and sales.
            </p>
            ...
            <div className='flex flex-wrap gap-2.5 md:gap-5 md:flex-nowrap items-start'>
              ...
              <div className='text-[16px] space-y-2.5'>
                ...
                <p className='info-text'>
                  Check your product's availability in real-time to avoid
                  overselling or missing a sales opportunity.
                </p>
              </div>
            </div>
          </div>
          <div className='w-full wow fadeInRight'>
            <div className='flex flex-wrap gap-2.5 md:gap-5 md:flex-nowrap items-start'>
              ...
              <div className='text-[16px] space-y-2.5'>
                ...
                <p className='info-text'>
                  Simple, easy tools built for manufacturers and small
                  organizations allow you to classify and manage resources
                  easily.
                </p>
              </div>
            </div>
          ...
          <div className='w-full wow fadeInRight'>
            <div className='flex flex-wrap gap-2.5 md:gap-5 md:flex-nowrap items-start'>
              ...
              <div className='text-[16px] space-y-2.5'>
                ...
                <p className='info-text'>
                  Highlight special, one-time items with ease and track their
          ...
          <div className='w-full wow fadeInRight'>
            <div className='flex flex-wrap gap-2.5 md:gap-5 md:flex-nowrap items-start'>
              ...
              <div className='text-[16px] space-y-2.5'>
                ...
                <p className='info-text'>
                  Make changes to product specifications or stock levels in
                  seconds, all from your dashboard.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className='flex items-center gap-5 flex-grow flex-wrap sm:flex-nowrap'>
            ...
            <div>
              ...
              <p className='info-text text-[#6a6a74]'>
                Get started with Trimmo.bio today and transform the way you
            ...
            <div className='box1 flex flex-col justify-between'>
              ...
              <div className='mt-8'>
                ...
                <div className='text-[16px] mt-5 flex items-start gap-3'>
                  ...
                  <p className='info-text mt-2'>
                    Scale your store effortlessly as your product selection
                    expands.
                  </p>
                </div>
                <div className='text-[16px] mt-5 flex items-start gap-3'>
                  ...
                  <p className='info-text mt-2'>
                    I concentrate on sales as we cope with inventory
                    complications.
                  </p>
                </div>
              </div>
