    ...
    <div className="flex flex-col gap-[80px] lg:gap-[120px] pb-[80px] lg:pb-[120px]">
        ...
        <div className="flex flex-wrap lg:flex-nowrap items-center pt-10 w-full justify-between">
          <div className="w-full lg:w-1/2">
            ...
            <p className="mb-5 text-[18px]">
              Trimmo.bio helps you simplify your Social media widgets. These powerful tools
              seamlessly link your preferred social platforms, allowing your audience to easily
              explore, develop, and engage with everything you have to offer.
            </p>
            <p className="mb-10 text-[18px]">
              Social media widgets are dynamic tools that allow you to show content from your social
              media networks right on your Trimmo.bio website.
            </p>
      ...
      <section className="overflow-hidden container choose-us">
        <div className=" w-full wow fadeInUp mb-10 mx-auto text-center">
          <h2 className="primary-font title">Key Features of Social Media Widgets</h2>
        ...
        <div className="grid grid-cols-1 wow fadeInUp md:grid-cols-2 xl:grid-cols-3 mt-8 gap-8">
          <div className="trending-apps-box border">
            ...
            <p className="mt-3 text-[14px] lg:text-base text-[#6a6a74]">
              From TikTok videos to Instagram Reels, Twitter tweets, and Pinterest boards, display
              your content with ease and engagement.
            </p>
          </div>
          <div className="trending-apps-box border">
            <span className="choose-us-icon-box mb-4">
            ...
            <p className="mt-3 text-[14px] lg:text-base text-[#6a6a74]">
              Sync the most recent news, videos, or stories from your social media accounts to keep
              your Trimmo.bio fresh and exciting.
            </p>
          </div>
          <div className="trending-apps-box border">
            <span className="choose-us-icon-box mb-4">
            ...
            <p className="mt-3 text-[14px] lg:text-base text-[#6a6a74]">
              Match your social widgets to your brand's style. Select the colors, layout, and
              display choices that best match your profile.
            </p>
          </div>
          <div className="trending-apps-box border">
            <span className="choose-us-icon-box mb-4">
            ...
            <p className="mt-3 text-[14px] lg:text-base text-[#6a6a74]">
              Encourage visitors to follow, like, comment, and share your content with the widgets.
            </p>
          </div>
          <div className="trending-apps-box border">
            <span className="choose-us-icon-box mb-4">
            ...
            <p className="mt-3 text-[14px] lg:text-base text-[#6a6a74]">
              Our widgets support various platforms, like Snapchat, LinkedIn, Pinterest, and
              Spotify, allowing you to reach your audience anywhere.
            </p>
          </div>
          <div className="trending-apps-box border">
            <span className="choose-us-icon-box mb-4">
            ...
            <p className="mt-3 text-[14px] lg:text-base text-[#6a6a74]">
              Your audience moves, and so does Trimmo.bio. Our pages are responsive and look
              excellent on any device, ensuring that your material is constantly available and
              visually appealing.
            </p>
          </div>
        </div>
      ...
      <section className="flex items-center container flex-wrap lg:flex-nowrap gap-10">
        ...
        <div className="w-full lg:w-1/2 wow fadeInLeft">
          <div>
            ...
            <h3 className="primary-font mt-4 lg:mt-8 text-base lg:text-xl">Drive Traffic</h3>
            <p className="info-text mt-1 lg:mt-2">
              Direct visitors to your social media profiles to boost the number of followers.
            </p>
            <h3 className="primary-font mt-6 text-base lg:text-xl">Showcase Your Best Content</h3>
            <p className="info-text mt-1 lg:mt-2">
              Highlight your most important or trending posts.
            </p>
            <h3 className="primary-font mt-6 text-base lg:text-xl">Save Time</h3>
            <p className="info-text mt-1 lg:mt-2">
              To keep resource allocations and renewals consistent, use automated synchronization.
            </p>
            <h3 className="primary-font mt-6 text-base lg:text-xl">Improve Visibility</h3>
            <p className="info-text mt-1 lg:mt-2">
              This increases your chances of getting discovered by potential fans, followers, or
              customers.
            </p>
          </div>
        </div>
      ...
      <div className="grid work grid-cols-1 md:grid-cols-2 container xl:grid-cols-3 gap-5">
        ...
        >
          ...
          <h4 className="primary-font text-base lg:text-xl text-left">Instagram Feed Widget</h4>
          <p className="info-text">
            Use the Instagram feed widget to showcase your gorgeous photographs and reels,
            attracting fast attention.
          </p>
          <div>
        ...
        >
          ...
          <h4 className="primary-font text-base lg:text-xl text-left">TikTok Video Widget</h4>
          <p className="info-text">
            Highlight your most memorable TikTok moments and engage viewers directly.
          </p>
          <div>
            <a
        ...
        >
          ...
          <h4 className="primary-font text-base lg:text-xl text-left">YouTube Video Widget</h4>
          <p className="info-text">
            Showcase your most recent video or playlist to gain views and subscribers.
          </p>
          <div>
        ...
        >
          ...
          <h4 className="primary-font text-base lg:text-xl text-left">Twitter Feed Widget</h4>
          <p className="info-text">
            Integrate your X feed so your viewers can see your most recent tweets.
          </p>
          <div>
            <a
              href="https://admin.shopeasy.ai/register"
        ...
        >
          ...
          <h4 className="primary-font text-base lg:text-xl text-left">Pinterest Board Widget</h4>
          <p className="info-text">Display innovative boards and pins to excite your audience.</p>
          <div>
            <button className="relative read-more job-2">
              Read More
              <span className="absolute right-1 top-1 bg-[#9d9afe] rounded-full z-10 flex items-center justify-center">
        ...
        >
          ...
          <h4 className="primary-font text-base lg:text-xl text-left">Spotify Widget</h4>
          <p className="info-text">
            Share your favorite playlists, songs, or podcasts to connect with other music fans.
          </p>
          <div>
            <button className="relative read-more job-3">
              Read More
      ...
      <section className="flex items-center container flex-wrap lg:flex-nowrap gap-10">
        <div className="w-full lg:w-1/2 wow fadeInLeft">
          <div>
            ...
            <h3 className="primary-font mt-4 lg:mt-8 text-base lg:text-xl">Sign In</h3>
            <p className="info-text mt-1 lg:mt-2">Log into your Trimmo.bio account.</p>
            <h3 className="primary-font mt-6 text-base lg:text-xl">Choose a Widget</h3>
            <p className="info-text mt-1 lg:mt-2">
              Browse our Social Media Widgets library and select the platform you wish to integrate
              with.
            </p>
            <h3 className="primary-font mt-6 text-base lg:text-xl">Customize</h3>
            <p className="info-text mt-1 lg:mt-2">
              Adjust the colors, layout, and style to reflect your brand.
            </p>
            <h3 className="primary-font mt-6 text-base lg:text-xl">Publish</h3>
            <p className="info-text mt-1 lg:mt-2">
              Save your modifications and make your widget available for your audience to view.
            </p>
          </div>
        </div>
        <div className="w-full lg:w-1/2 wow fadeInRight">
          ...
          <div className="flex items-center gap-5 flex-grow flex-wrap sm:flex-nowrap">
            ...
            <div>
              ...
              <p className="info-text text-[#6a6a74]">
                Trimmo.bio Social media widgets enhance your content's visual appeal, engagement,
                and shareability. Whether you're a creator, influencer, entrepreneur, or brand,
                these tools will help you strengthen your connection with your audience.
              </p>
            </div>
          </div>
