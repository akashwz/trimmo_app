    ...
    <div className="flex flex-col gap-[80px] lg:gap-[120px] pb-[80px] lg:pb-[120px]">
      <div className="pt-[20px] container sm:pt-[70px] md:pt-10 herosection">
        <div className="flex flex-wrap lg:flex-nowrap items-center pt-10 w-full justify-between">
          <div className="w-full lg:w-1/2">
            <h2 className="mb-6">Trimmo.bio for Instagram: Your Ultimate Link in Bio Tool</h2>
            <p className="mb-5 text-[18px]">
              Trimmo.bio helps thousands of creators, influencers, brands, and business owners
              share, monetize, and build their online presence with a single link. It is the best
              link-in bio tool created for Instagram and beyond.
            </p>
        ...
        <div className="grid grid-cols-1 wow fadeInUp md:grid-cols-2 xl:grid-cols-3 mt-8 gap-8">
          <div className="trending-apps-box border">
            ...
            <p className="mt-3 text-[14px] lg:text-base text-[#6a6a74]">
              Give your audience fast access to everything you have to offer, including blog pieces,
              social network posts, online stores, and services.
            </p>
          </div>
          <div className="trending-apps-box border">
            <span className="choose-us-icon-box mb-4">
            ...
            <p className="mt-3 text-[14px] lg:text-base text-[#6a6a74]">
              Sell products, accept service payments, and even set up a "Tip Jar" to earn directly
              from your followers.
            </p>
          </div>
          <div className="trending-apps-box border">
            ...
            <p className="mt-3 text-[14px] lg:text-base text-[#6a6a74]">
              Analytics may provide you with important insights about your audience and help you
              optimize your strategy for more engagement and sales.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="flex items-center container flex-wrap lg:flex-nowrap gap-10">
        <div className="w-full lg:w-1/2 wow fadeInLeft">
          <div>
            ...
            <h3 className="primary-font mt-4 lg:mt-8 text-base lg:text-xl">Step 1</h3>
            ...
            <p className="info-text mt-1 lg:mt-2">Include your unique URL in your Instagram bio.</p>
            <h3 className="primary-font mt-6 text-base lg:text-xl">Step 3</h3>
            <p className="info-text mt-1 lg:mt-2">
              Use one link to share your content, offer things, and draw an audience.
            </p>
          </div>
        </div>
      ...
      <section className="container">
        ...
        <div className="grid work grid-cols-1 md:grid-cols-2  xl:grid-cols-3 gap-5">
          ...
          >
            ...
            <p>
              Connect your store and receive payments immediately using your Trimmo.bio link.No
              complex technical processes or procedures are required.
            </p>
          </div>
          <div
            className="work-box gap-4 wow fadeInUp flex flex-col"
          ...
          >
            ...
            <h4 className="primary-font text-base lg:text-xl text-left">Drive More Sales</h4>
            <p>
              Use a personalized call-to-action to direct followers to the items you sell. Integrate
              your store easily for a consistent experience.
            </p>
          </div>
          <div
            className="work-box gap-4 wow fadeInUp flex flex-col"
          ...
          >
            ...
            <p>
              Keep followers informed about news, deals, and promotions. By giving customers direct
              access to your store, you can build trust and loyalty.
            </p>
          </div>
        </div>
      </section>
      <section className="flex items-center container flex-wrap lg:flex-nowrap gap-10">
        ...
        <div className="w-full lg:w-1/2 order-1 lg:order-2 wow fadeInLeft">
          <div>
            <h2 className="primary-font mb-2 title w-full">Start Growing with Trimmo.bio</h2>
            <p>
              Join the successful network of creatives, influencers, and business owners who use
              Trimmo.bio to boost their reach and earnings.
            </p>
            <ul className="list-disc pl-10 mt-5">
              <li className="mb-3">Trimmo.bio takes only a few minutes to create.</li>
              <li className="mb-3">Add it to your Instagram bio to streamline your material.</li>
              <li className="mb-3">
      ...
      <section className="flex items-center container flex-wrap lg:flex-nowrap gap-10">
        <div className="w-full lg:w-1/2 wow fadeInLeft">
          <div>
            ...
            <p className="mb-4">
              Trimmo.bio is more than simply a link-in-bio tool; it's a full-featured platform for
              sharing, engaging, and expanding. Whether you're an influencer, creative, or store
              owner, Trimmo.bio is the simplest way to make your Instagram bio work for you.
            </p>
