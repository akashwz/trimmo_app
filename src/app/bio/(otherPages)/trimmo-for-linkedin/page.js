      ...
      <div className="pt-[20px] container sm:pt-[70px] md:pt-10 herosection">
        <div className="flex flex-wrap lg:flex-nowrap items-center pt-10 w-full justify-between">
          <div className="w-full lg:w-1/2">
            <h2 className="mb-6">Enhance Your LinkedIn Presence with Trimmo.bio</h2>
            <p className="mb-5 text-[18px]">
              Transform your LinkedIn profile into an effective tool for displaying what you offer.
              Trimmo.bio allows you to easily connect your network with your greatest material,
              create your professional identity, and grow your community all with a single link.
            </p>
        ...
        <div className="w-full lg:w-1/2 wow fadeInLeft">
          <div>
            ...
            <p className="info-text mt-1 lg:mt-2">
              Sign up for free in under a minute. Customize your Trimmo.bio with background
              photographs, profile photos, and unlimited links.
            </p>
            <h3 className="primary-font mt-6 text-base lg:text-xl">Step 2</h3>
            <p className="info-text mt-1 lg:mt-2">
              Access the "Resources" section of your profile and enable LinkedIn Creator Mode. Add
              your Trimmo.bio URL to the "Website" area for quick reference.
            </p>
            <h3 className="primary-font mt-6 text-base lg:text-xl">Step 3</h3>
            <p className="info-text mt-1 lg:mt-2">
              Use the Trimmo.bio link on your profile, in direct messages, and in post comments.
              Allow your network to view your content, buy your items, and give all in one spot.
            </p>
          </div>
        </div>
      ...
      <section className="flex items-center container flex-wrap lg:flex-nowrap gap-10">
        ...
        <div className="w-full lg:w-1/2 order-1 lg:order-2 wow fadeInLeft">
          <div>
            ...
            <p>
              LinkedIn is no longer just for job seekers—it’s a hub for professionals to share
              ideas, collaborate, and grow. With Trimmo.bio, you can:
            </p>
            <ul className="list-disc pl-10 mt-5">
              <li className="mb-3">
                Strengthen your brand identity with a professional link in bio.
              </li>
              <li className="mb-3">You are recognized as a professional in your field.</li>
              <li className="mb-3">Stand out in a busy digital space.</li>
            </ul>
          </div>
        </div>
      </section>
      <section className="flex items-center container flex-wrap lg:flex-nowrap gap-10">
        <div className="w-full lg:w-1/2 wow fadeInLeft">
          <div>
            ...
            <p className="mb-4">
              Join the over 50 million artists, influencers, and brands who use Trimmo.bio to
              improve their online presence. Create your brand identification, expand your network,
              and connect audiences to everything you do with one simple link.
            </p>
