    ...
    <div className="flex flex-col gap-[80px] lg:gap-[120px] pb-[80px] lg:pb-[120px]">
        ...
        <div className="flex flex-wrap lg:flex-nowrap items-center pt-10 w-full justify-between">
          <div className="w-full lg:w-1/2">
            ...
            <p className="mb-5 text-[18px]">
              Trimmo.bio, the best link-in-bio tool, can help you take your TikTok profile to the
              next level. Showcase your greatest videos, build a following, and easily engage with
              your audience.
            </p>
        ...
        <div className="grid grid-cols-1 wow fadeInUp md:grid-cols-2 mt-8 gap-8">
          <div className="trending-apps-box border">
            ...
            <p className="mt-3 text-[14px] lg:text-base text-[#6a6a74]">
              Publish your favorite videos so that your audience can easily find your work and
              follow you for more.
            </p>
          </div>
          <div className="trending-apps-box border">
            ...
            <p className="mt-3 text-[14px] lg:text-base text-[#6a6a74]">
              Curate a collection of six great TikTok videos to convert visitors into fans. Share
              your profile and videos with a few clicks.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="flex items-center container flex-wrap lg:flex-nowrap gap-10">
        <div className="w-full lg:w-1/2 wow fadeInLeft">
          <div>
            <h2 className="primary-font title w-full">How Trimmo.bio Works for TikTok</h2>
            <h3 className="primary-font mt-4 lg:mt-8 text-base lg:text-xl">Step 1</h3>
            <p className="mt-1 lg:mt-2">
              Trimmo. Again registration takes only seconds. You can customize your page with an
              endless number of backgrounds, photos, and links.
            </p>
            <h3 className="primary-font mt-6 text-base lg:text-xl">Step 2</h3>
            <p className="mt-1 lg:mt-2">
              Include your unique Trimmo.bio URL in your TikTok bio. Never change your bio link;
              instead, manage all of your content in one spot.
            </p>
            <h3 className="primary-font mt-6 text-base lg:text-xl">Step 3</h3>
            <p className="mt-1 lg:mt-2">
              Trimmo.bio Connect with your audience via everything you make. Engage with your
              followers to ensure simple access to your TikTok postings.
            </p>
          </div>
        </div>
      ...
      <section className="flex items-center container flex-wrap lg:flex-nowrap gap-10">
        ...
        <div className="w-full lg:w-1/2 order-1 lg:order-2 wow fadeInLeft">
          <div>
            <h2 className="primary-font mb-2 title w-full">Why Choose Trimmo.bio for TikTok?</h2>
            <ul className="list-disc pl-10 mt-5">
              <li className="mb-3">Publish your best TikToks with ease.</li>
              <li className="mb-3">Track clicks and engagement to optimize performance.</li>
              <li className="mb-3">Create brand associations through staff presence.</li>
              <li className="mb-3">Sell products and earn affiliate revenue.</li>
      ...
      <section className="flex items-center container flex-wrap lg:flex-nowrap gap-10">
        <div className="w-full lg:w-1/2 wow fadeInLeft">
          <div>
            ...
            <p className="mb-4">
              Trimmo.bio provides solutions for influencers, creators, and company owners to expand
              their TikTok audiences, display their material, and monetize their efforts.
            </p>
            <p className="mb-6">
              If your TikTok profile stands out on Trimmo.bio, you can convert any visitor into a
              follower, coworker, or customer. Begin presenting your films, growing your audience,
              and exploring new opportunities, all with one strong link in your profile.
            </p>
