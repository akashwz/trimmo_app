      ...
      <div className='pt-[20px] container sm:pt-[70px] md:pt-10 herosection'>
        <div className='flex flex-wrap lg:flex-nowrap items-center pt-10 w-100 justify-between'>
          <div className='w-full lg:w-1/2'>
            <h2 className='mb-6'>
              Explore the Power of Your Twitter Profile with Trimmo.bio
            </h2>
            <p className='mb-5 text-[18px]'>
              Trimmo.bio, the ultimate link-in bio solution for creators,
              influencers, and companies, can elevate your Twitter account to
              new heights. Go beyond 280 characters and connect your audience to
              all you do in a single, straightforward link.
            </p>
      ...
      <section className='overflow-hidden container choose-us'>
        <div className=' w-full wow fadeInUp mb-10 mx-auto text-center'>
          <h2 className='primary-font title'>
            Why Trimmo.bio is Perfect for Twitter?
          </h2>
        </div>
        <div className='grid grid-cols-1 wow fadeInUp md:grid-cols-2 mt-8 gap-8'>
          <div className='trending-apps-box border'>
            ...
            <p className='mt-3 text-[14px] lg:text-base text-[#6a6a74]'>
              With Trimmo.bio, you are not just 280 characters. Share blogs,
              product pages, social media platforms, albums, podcasts, and other
              content with a single link.
            </p>
          </div>
          <div className='trending-apps-box border'>
            <span className='choose-us-icon-box mb-4'>
            ...
            <p className='mt-3 text-[14px] lg:text-base text-[#6a6a74]'>
              Curate a collection of six great tweets to convert visitors into
              fans. Share your profile and videos with a few clicks.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className='w-full lg:w-1/2 wow fadeInLeft'>
          <div>
            ...
            <p className='mt-1 lg:mt-2'>
              Easily accept payments on Twitter and integrate Commerce Links
              with your store for smooth connectivity. Accept tips, donations,
              and payments for your services with ease.
            </p>
            <h3 className='primary-font mt-6 text-base lg:text-xl'>
              Add Videos and Forms
            </h3>
            <p className='mt-1 lg:mt-2'>
              Directly share videos from YouTube, Twitch, TikTok, or Vimeo on
              your page. Create forms to capture visitor email addresses, phone
            ...
            <p className='mt-1 lg:mt-2'>
              Use your Trimmo.bio URL to keep your Twitter profile up to date.
              Share your most recent blogs, videos, music, or promotions without
        ...
        <div className='w-full lg:w-1/2 order-1 lg:order-2 wow fadeInLeft'>
          <div>
            <h2 className='primary-font mb-2 title w-full'>
              Why Creators Love Trimmo.bio
            </h2>
            <ul className='list-disc pl-10 mt-5'>
              <li className='mb-3'>
                Understand what your followers are engaged about.
              </li>
              <li className='mb-3'>
                Accept payments and earn money immediately through Twitter.
              </li>
              <li className='mb-3'>Easily incorporate videos and podcasts.</li>
              <li className='mb-3'>
                Integrate your stores to simply boost sales.
              </li>
              <li className='mb-3'>
      ...
      <section className='flex items-center container flex-wrap lg:flex-nowrap gap-10'>
        <div className='w-full lg:w-1/2 wow fadeInLeft'>
          <div>
            ...
            <p className='mb-4'>
              Trimmo.bio allows your followers to easily see everything you're
              doing. Build engagement, drive traffic, and monetize your efforts
              while keeping your Twitter bio clean and simple.
            </p>
            <p className='mb-6'>
              Sign up for free today and start growing your Twitter presence!.
            </p>
