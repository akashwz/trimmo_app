...
const Appearance = () => {
  ...
  useEffect(() => {
    if (bioData) {
      setSelectedImage(bioData?.template);
      ...
      >
        ...
        <div className="lg:hidden flex justify-center">
          ...
          <div
            ...
            disabled={!isSaveEnabled || loader}
          >
            <button className="bottom-14 w-12 h-12 btn-green text-white rounded-full flex items-center justify-center transition-all duration-300 cursor-pointer relative disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:bg-green-400 disabled:hover:text-white">
