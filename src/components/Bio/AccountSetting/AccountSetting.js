    ...
    <>
          ...
          <form onSubmit={handleUserSubmit} className="space-y-4">
            ...
            <div>
              ...
              <input
                ...
                className="w-full mt-2 bg-transparent rounded-full border border-black focus:border-black focus:bg-white focus:ring-0 text-sm outline-none text-gray-700 py-1 px-4 leading-8 transition-colors duration-200 ease-in-out peer disabled:bg-gray-200 disabled:border-gray-300 disabled:text-gray-400"
                disabled
              />
            </div>
            ...
            <button
              ...
              disabled={loader || userNames?.data?.username === false || !isFormChanged}
            >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-8">
        <div className="bg-white rounded-lg shadow-lg p-6 flex flex-col justify-between">
          <div>
            <h3 className="mb-2">Publish profile</h3>
            <p>
        ...
        <div className="bg-white rounded-lg shadow-lg p-6">
          <div>
            <h3 className="mb-2">Delete my bio</h3>
            <p>
