...
const ProfileDetails = ({ handleProfileDetail, userDetails, setUserDetails }) => {
            ...
            <div className="grid mt-5 gap-8">
                ...
                <div className="ml-auto">
                    ...
                    <button
                        ...
                        className={`${!userDetails?.name ? "cursor-not-allowed opacity-50" : ""
