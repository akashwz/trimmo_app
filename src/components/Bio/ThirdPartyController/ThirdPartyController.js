        ...
        return (
          <div className="flex justify-center items-center w-full">
            {item?.app_name === "youtube" ? (
              ...
              <video width="640" height="360" className="rounded-lg shadow-lg w-full" controls>
        ...
        <>
          ...
          >
            <div
              ...
              style={{
                textTransform:
                  changeAppearanceData?.typography_style === "uppercase" && "uppercase",
                textDecoration:
                  changeAppearanceData?.typography_style === "underline" && "underline",
                fontStyle: changeAppearanceData?.typography_style === "italic" && "italic",
                fontWeight: changeAppearanceData?.typography_style === "bold" && "bold",
