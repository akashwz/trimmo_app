                ...
                <div className="flex flex-wrap -m-2">
                  ...
                  <div className="p-2 w-full">
                    <div className="relative">
                      ...
                      >
                        <span className=" w-4 h-4  flex items-center justify-center  rounded-full text-center text-white bg-themeGreen ">
                          ✔
                        </span>
                        <span>
                          {userData && userData?.data?.is_verified ? "Verified" : "Not Verified"}
                        </span>
                      </div>
                    </div>
                  </div>
