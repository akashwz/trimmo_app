  ...
  return (
    <>
      <div className="relative w-full overflow-hidden">
            ...
            <div className="transform animate-fade-in-up animation-delay-400 flex flex-col gap-14">
              ...
              <section className="relative w-full h-[600px] overflow-hidden">
                <div className="relative h-full w-full">
                  <div className="absolute w-[1010px] h-[540px] top-0 left-[300px] bg-[#1f905c1a] rounded-[505px_505px_0px_0px]" />
                  <div className="absolute w-[810px] h-[440px] top-[100px] left-[400px] bg-[#1f905c33] rounded-[430px_430px_0px_0px]" />
                  <div className="absolute w-[610px] h-[330px] top-[210px] left-[500px] bg-[#1f905c1a] rounded-[430px_430px_0px_0px]" />

                  <div className="absolute w-[1082px] h-[239px] top-[361px] left-[300px]">
                  ...
                  <div className="absolute w-[757px] h-[258px] top-[73px] left-[430px]">
        ...
        <div className="img-box my-[100px]">
          ...
          <div className="section-title flex flex-col items-center justify-center w-[80%] mx-auto mt-20 gap-12">
